...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant checkbox, radio et switch contrôlés avec états de sélection séparés.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxCheckbox, IuxRadio, IuxSwitch. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
