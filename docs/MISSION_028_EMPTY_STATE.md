...
## 2. Contexte
Cette mission apporte états sans contenu avec explication et action de reprise pertinente pour la première version exploitable.
...
## 9. API attendue
Concevoir une API concise autour de IuxEmptyState, sans couleurs, ombres, rayons ni paramètres de mouvement arbitraires.
