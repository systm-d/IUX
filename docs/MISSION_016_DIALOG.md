...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant dialogue modal de décision avec focus, échappement et retour du focus.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxDialog. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
