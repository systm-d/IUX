...
# IUX-014 — Inline Feedback, Alerts and Banners
...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant messages persistants en ligne, alertes et bannières avec hiérarchie sémantique.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxAlert, IuxBanner. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
