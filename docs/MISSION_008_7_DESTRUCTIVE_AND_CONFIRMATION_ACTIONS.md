...
# IUX-008.7 — Destructive and Confirmation Actions
...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant actions destructives et politiques de confirmation proportionnées et réversibles lorsque possible.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxDestructiveAction, IuxConfirmationAction. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
