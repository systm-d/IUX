...
# IUX-025 — Navigation Rail and Adaptive Navigation
...
## 2. Contexte
Cette mission apporte navigation adaptative pour grands écrans sans privilégier le desktop pour la première version exploitable.
...
## 9. API attendue
Concevoir une API concise autour de IuxNavigationRail, IuxAdaptiveNavigation, sans couleurs, ombres, rayons ni paramètres de mouvement arbitraires.
