...
# IUX-021 — Badge, Chip and Status Indicators
...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant indicateurs de statut et filtres concis sans dépendre uniquement de la couleur.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxBadge, IuxChip. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
