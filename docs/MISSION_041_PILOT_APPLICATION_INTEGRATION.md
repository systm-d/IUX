...
# IUX-041 — Pilot Application Integration
...
## 2. Contexte
Cette mission apporte intégration pilote démontrant une page, formulaire, feedback et navigation pour la première version exploitable.
...
## 9. API attendue
Concevoir une API concise autour de pilot integration, sans couleurs, ombres, rayons ni paramètres de mouvement arbitraires.
