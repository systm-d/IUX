...
# IUX-013 — Progress and Loading Indicators
...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant indicateurs de progression déterminée et indéterminée sans shimmer décoratif.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxProgressIndicator, IuxLoadingIndicator. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
