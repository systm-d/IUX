...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant éléments de liste et listes accessibles, avec densité et texte long.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxListItem, IuxList. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
