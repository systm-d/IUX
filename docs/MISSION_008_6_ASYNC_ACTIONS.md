...
## 2. Contexte
Cette mission poursuit la première version exploitable en apportant actions asynchrones contrôlées, prévention de répétition et rendu de progression.
...
## 9. API attendue
Concevoir une API publique concise autour de IuxAsyncAction. Elle ne doit exposer ni couleurs, ni ombres, ni rayons, ni valeurs de mouvement arbitraires.
